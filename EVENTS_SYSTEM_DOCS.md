...
4. **Artist Talk: The Poetry of Materials** - Paris ⭐ Featured
   ...
   - Q&A and reception
   - Free with RSVP
5. **Art Paris 2025** (Art Fair) - Grand Palais ⭐ Featured
   - April 4-7, 2025
...
```typescript
{
  ...
  schedule: {
    ...
    endDate: '2025-07-15',
    openingReception: '2025-06-01T18:00:00', // Optional
    hours: {
  ...
  tags: ['exhibition', 'paris', 'contemporary', 'summer 2025']
}
```
